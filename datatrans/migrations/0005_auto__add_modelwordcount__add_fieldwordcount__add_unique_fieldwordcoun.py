...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'KeyValue.object_id'
        db.alter_column('datatrans_keyvalue', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'KeyValue.content_type'
        db.alter_column('datatrans_keyvalue', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'KeyValue.object_id'
        db.alter_column('datatrans_keyvalue', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))

        # Changing field 'KeyValue.content_type'
        db.alter_column('datatrans_keyvalue', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['contenttypes.ContentType']))
